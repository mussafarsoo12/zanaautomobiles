  ...
  if (existingCars.length === 0) {
    const sampleCars = [
      ...
      },
      {
        ...
        interiorColor: "Sport",
        availability: "Disponible",
        images: ["https://images.unsplash.com/photo-1517524008436-bbdb53ac544a?auto=format&fit=crop&q=80&w=1600"],
        features: ["Sport", "Expertisée", "Dernière MFK : 01.07.2024"],
        description: "05.2009. Essence. 137'000 km. 100 PS (73 kW). Boîte manuelle. 6.3 l/100 km. Contrôle technique OK.",
        isFeatured: true
      },
      {
        make: "Renault",
